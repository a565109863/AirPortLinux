/* add your code here */
#ifndef AirPortLinux_h
#define AirPortLinux_h
...
class AirPortLinux : public IOController
{
    OSDeclareDefaultStructors(AirPortLinux)
...
private:
    ...
    // 90 - SCANCACHE_CLEAR
    IOReturn setSCANCACHE_CLEAR(IOInterface* interface, void *);
    //    // 112 - FACTORY_MODE

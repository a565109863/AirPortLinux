				  ...
				  struct ieee80211_tx_info *info)
{
	...
	r->idx = iwlagn_hwrate_to_mac80211_idx(rate_n_flags, (enum nl80211_band)info->band);
}
				   ...
				   struct iwl_rx_cmd_buffer *rxb)
{
	...
	skb_queue_walk(&reclaimed_skbs, skb) {
		...
		iwl_trans_free_tx_cmd(priv->trans, (struct iwl_device_tx_cmd *)info->driver_data[1]);

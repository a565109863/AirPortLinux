...
void rb_replace_node_rcu(struct rb_node *victim, struct rb_node *_new,
             struct rb_root *root)
{
    struct rb_node *parent = rb_parent(victim);
    ...
    *_new = *victim;
    ...
    /* Set the parent's pointer to the _new node last after an RCU barrier
     * so that the pointers onwards are seen to be set correctly when doing
     * an RCU walk over the tree.
     */
    __rb_change_child_rcu(victim, _new, parent, root);
}

...
{
    const u8 *ret = (const u8 *)&he_oper->optional;
    u32 he_oper_params;
    ...
    return (const struct ieee80211_he_6ghz_oper *)ret;
}
...
static inline bool ieee80211_is_robust_mgmt_frame(struct sk_buff *skb)
{
    if (skb->len < IEEE80211_MIN_ACTION_SIZE)
        return false;
    return _ieee80211_is_robust_mgmt_frame((struct ieee80211_hdr *)skb->data);
}
...
static inline bool ieee80211_is_group_privacy_action(struct sk_buff *skb)
{
    if (skb->len < IEEE80211_MIN_ACTION_SIZE)
        return false;
    return _ieee80211_is_group_privacy_action((struct ieee80211_hdr *)skb->data);
}

    ...
    unsigned int hash_rnd)
{
    ...
    if (!__builtin_constant_p(params.key_len))
        ...
        if (params.hashfn)
            ...
            hash = jhash2((const u32 *)key, key_len / sizeof(u32), hash_rnd);
    } else {
...
{
    const char *ptr = (const char *)rht_obj(ht, he);
                     ...
                     struct rhash_head *obj)
{
    ...
    if (rht_is_a_nulls(obj))
        obj = NULL;
    rcu_assign_pointer(*p, (struct rhash_head *)((unsigned long)obj | BIT(0)));
}
...
static inline int rhltable_insert(
    ...
    const struct rhashtable_params params)
{
    const char *key = (const char *)rht_obj(&hlt->ht, &list->rhead);
...
static inline int rhashtable_lookup_insert_fast(
    ...
    const struct rhashtable_params params)
{
    const char *key = (const char *)rht_obj(ht, obj);
    void *ret;

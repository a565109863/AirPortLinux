                       ...
                       bool initiator)
{
    ...
    lnkid = (struct ieee80211_tdls_lnkie *)skb_put(skb, sizeof(struct ieee80211_tdls_lnkie));
                        ...
                        struct sk_buff *skb)
{
    ...
    wmm = (struct ieee80211_wmm_param_ie *)skb_put_zero(skb, sizeof(*wmm));
                   ...
                   const u8 *extra_ies, size_t extra_ies_len)
{
    ...
    if (local->hw.queues >= IEEE80211_NUM_ACS &&
        ...
        ieee80211_add_wmm_info_ie((u8 *)skb_put(skb, 9), 0); /* no U-APSD */
                   ...
                   u16 status_code, struct sk_buff *skb)
{
    ...
    tf = (struct ieee80211_tdls_data *)skb_put(skb, offsetof(struct ieee80211_tdls_data, u));
...
iee80211_tdls_add_ch_switch_timing(u8 *buf, u16 switch_time, u16 switch_timeout)
{
    ...
    *buf++ = sizeof(struct ieee80211_ch_switch_timing);
    ...
    ch_sw = (struct ieee80211_ch_switch_timing *)buf;
                  ...
                  u32 *ch_sw_tm_ie_offset)
{
    ...
    if (chandef->width == NL80211_CHAN_WIDTH_40) {
        ...
        *pos++ = sizeof(*sec_chan_ie);
        sec_chan_ie = (struct ieee80211_sec_chan_offs_ie *)pos;
                       ...
                       struct sk_buff *skb)
{
    ...
    struct sta_info *sta;
    struct ieee80211_tdls_data *tf = (struct ieee80211_tdls_data *)skb->data;

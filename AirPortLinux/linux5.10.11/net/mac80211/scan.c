              ...
              struct ieee80211_channel *channel)
{
    ...
    if (ieee80211_is_probe_resp(mgmt->frame_control)) {
        ...
        struct ieee80211_ext *ext = (struct ieee80211_ext *) mgmt;
    ...
    DebugLog("-----%s: line = %d irq cbss->bssid=%s, mgmt->bssid=%s\n", __FUNCTION__, __LINE__, ether_sprintf(cbss->bssid), ether_sprintf(mgmt->bssid));
    ...
    list_for_each_entry(non_tx_cbss, &cbss->nontrans_list, nontrans_list) {
        non_tx_bss = (struct ieee80211_bss *)non_tx_cbss->priv;
...
static bool ieee80211_prep_hw_scan(struct ieee80211_sub_if_data *sdata)
{
    ...
    if (ieee80211_hw_check(&local->hw, SINGLE_SCAN_ON_ALL_BANDS)) {
        ...
        do {
            ...
            int i = local->hw_scan_band;
            local->hw_scan_band = (enum nl80211_band)(i+1);
        } while (!n_chans);
    }
                  ...
                  struct cfg80211_scan_request *req)
{
 ...
 again:
    if (hw_scan) {
        ...
        local->hw_scan_req = (struct ieee80211_scan_request *)kmalloc(
        ...
        local->hw_scan_band = (enum nl80211_band)0;
                    ...
                    struct cfg80211_sched_scan_request *req)
{
    ...
    ie = (u8 *)kcalloc(iebufsz, num_bands, GFP_KERNEL);
    if (!ie) {
        ret = -ENOMEM;
        goto out;
    }

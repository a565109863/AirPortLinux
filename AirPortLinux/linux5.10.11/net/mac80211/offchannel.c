                    ...
                    enum ieee80211_roc_type type)
{
    ...
    roc = (typeof(roc))kzalloc(sizeof(*roc), GFP_KERNEL);
    if (!roc)
        return -ENOMEM;
              ...
              struct cfg80211_mgmt_tx_params *params, u64 *cookie)
{
    ...
    struct sk_buff *skb;
    struct sta_info *sta;
    const struct ieee80211_mgmt *mgmt = (typeof(mgmt))params->buf;
    ...
    data = (typeof(data))skb_put_data(skb, params->buf, params->len);

...
static void *lib80211_ccmp_init(int key_idx)
{
	...
	priv = (struct lib80211_ccmp_data *)kzalloc(sizeof(*priv), GFP_ATOMIC);
	if (priv == NULL)
		goto fail;
...
{
	struct lib80211_ccmp_data *_priv = (struct lib80211_ccmp_data *)priv;
	if (_priv && _priv->tfm)
...
{
	struct lib80211_ccmp_data *key = (struct lib80211_ccmp_data *)priv;
	int i;
	u8 *pos;
	...
	pos = (u8 *)skb_push(skb, CCMP_HDR_LEN);
...
{
	struct lib80211_ccmp_data *data = (struct lib80211_ccmp_data *)priv;
	int keyidx;
...
{
	struct lib80211_ccmp_data *ccmp = (struct lib80211_ccmp_data *)priv;

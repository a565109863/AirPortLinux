...
{
	struct lib80211_tkip_data *_priv = (struct lib80211_tkip_data *)priv;
...
static void *lib80211_tkip_init(int key_idx)
{
	...
	priv = (struct lib80211_tkip_data *)kzalloc(sizeof(*priv), GFP_ATOMIC);
	if (priv == NULL)
		goto fail;
...
{
	struct lib80211_tkip_data *tkey = (struct lib80211_tkip_data *)priv;
	u8 *pos;
	...
	pos = (u8 *)skb_push(skb, TKIP_HDR_LEN);
...
{
	struct lib80211_tkip_data *tkip = (struct lib80211_tkip_data *)priv;
	seq_printf(m,

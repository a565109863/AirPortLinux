         ...
         void *ptr, int len, int size)
{
    ...
    get_page(page);
    page_offset = (char *)ptr - (char *)page_address(page);
                   ...
                   void *data)
{
    ...
    enum nl80211_dfs_regions region = (enum nl80211_dfs_regions)0;
    int i, j, iftype;
    ...
    for (iftype = 0; iftype < NUM_NL80211_IFTYPES; iftype++) {
        ...
        if (params->iftype_num[iftype] > 0 &&
            !cfg80211_iftype_allowed(wiphy, (enum nl80211_iftype)iftype, 0, 1))
    ...
    for (i = 0; i < wiphy->n_iface_combinations; i++) {
        ...
        for (iftype = 0; iftype < NUM_NL80211_IFTYPES; iftype++) {
            if (cfg80211_iftype_allowed(wiphy, (enum nl80211_iftype)iftype, 0, 1))
                continue;

               ...
               struct cfg80211_csa_settings *csa_settings)
{
    ...
    frame_len = sizeof(struct ieee80211_hdr_3addr) +
            ...
            ifibss->ie_len;
    presp = (typeof(presp))kzalloc(sizeof(*presp) + frame_len, GFP_KERNEL);
    if (!presp)
        return NULL;

    presp->head = (typeof(presp->head))(presp + 1);

    mgmt = (typeof(mgmt)) presp->head;
                      ...
                      bool creator)
{
    ...
    ifibss->state = ieee80211_if_ibss::IEEE80211_IBSS_MLME_JOINED;
    ...
    __acquires(RCU)
{
    ...
    if (ifibss->state == ieee80211_if_ibss::IEEE80211_IBSS_MLME_SEARCH) {
        rcu_read_lock();
        return NULL;
    }
...
static void ieee80211_ibss_disconnect(struct ieee80211_sub_if_data *sdata)
{
    ...
    ifibss->state = ieee80211_if_ibss::IEEE80211_IBSS_MLME_SEARCH;
...
static void ieee80211_rx_mgmt_probe_req(struct ieee80211_sub_if_data *sdata,
                    struct sk_buff *req)
{
    struct ieee80211_mgmt *mgmt = (typeof(mgmt))req->data;
    struct ieee80211_if_ibss *ifibss = &sdata->u.ibss;
    struct ieee80211_local *local = sdata->local;
    ...
    if (ifibss->state != ieee80211_if_ibss::IEEE80211_IBSS_MLME_JOINED ||
        len < 24 + 2 || !presp)
        return;
...
void ieee80211_ibss_work(struct ieee80211_sub_if_data *sdata)
{
    ...
    switch (ifibss->state) {
        case ieee80211_if_ibss::IEEE80211_IBSS_MLME_SEARCH:
        ieee80211_sta_find_ibss(sdata);
        break;
        case ieee80211_if_ibss::IEEE80211_IBSS_MLME_JOINED:
            ...
            struct cfg80211_ibss_params *params)
{
    ...
    if (params->ie) {
        sdata->u.ibss.ie = (typeof(sdata->u.ibss.ie))kmemdup(params->ie, params->ie_len,
                       GFP_KERNEL);
        if (sdata->u.ibss.ie)
            sdata->u.ibss.ie_len = params->ie_len;
    }

    sdata->u.ibss.state = ieee80211_if_ibss::IEEE80211_IBSS_MLME_SEARCH;

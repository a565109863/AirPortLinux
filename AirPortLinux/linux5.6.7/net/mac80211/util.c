...
bool ieee80211_chandef_vht_oper(struct ieee80211_hw *hw,
                ...
                struct cfg80211_chan_def *chandef)
{
    struct cfg80211_chan_def nnew = *chandef;
    int cf0, cf1;
    ...
    case IEEE80211_VHT_CHANWIDTH_80MHZ:
        nnew.width = NL80211_CHAN_WIDTH_80;
        nnew.center_freq1 = cf0;
        ...
        if (ccf1) {
            ...
            if ((diff == 8) && support_160) {
                nnew.width = NL80211_CHAN_WIDTH_160;
                nnew.center_freq1 = cf1;
            } else if ((diff > 8) && support_80_80) {
                nnew.width = NL80211_CHAN_WIDTH_80P80;
                nnew.center_freq2 = cf1;
            }
        }
        break;
    ...
    if (!cfg80211_chandef_valid(&nnew))
        return false;

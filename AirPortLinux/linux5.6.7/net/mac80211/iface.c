...
static int ieee80211_change_mac(struct net_device *dev, void *addr)
{
    ...
    ret = ieee80211_verify_mac(sdata, (u8 *)sa->sa_data, check_dup);
    if (ret)
        return ret;
...
int ieee80211_add_virtual_monitor(struct ieee80211_local *local)
{
    ...
    sdata = (struct ieee80211_sub_if_data *)kzalloc(sizeof(*sdata) + local->hw.vif_data_size, GFP_KERNEL);
    if (!sdata)
        return -ENOMEM;
                      ...
                      struct net_device *sb_dev)
{
    ...
    struct ieee80211_radiotap_header *rtap = (struct ieee80211_radiotap_header *)skb->data;
    ...
    hdr = (struct ieee80211_hdr *)((u8 *)skb->data + le16_to_cpu(rtap->it_len));

    return ieee80211_select_queue_80211(sdata, skb, hdr);
}

struct net_device_ops ieee80211_monitorif_ops = {
    .ndo_open        = ieee80211_open,
    .ndo_stop        = ieee80211_stop,
    .ndo_uninit        = ieee80211_uninit,
    ...
    while ((skb = skb_dequeue(&sdata->skb_queue))) {
        ...
        if (ieee80211_is_action(mgmt->frame_control) &&
            ...
            case WLAN_VHT_ACTION_OPMODE_NOTIF: {
                ...
                band = (enum nl80211_band)status->band;
             ...
             struct vif_params *params)
{
    ...
    if (type == NL80211_IFTYPE_P2P_DEVICE || type == NL80211_IFTYPE_NAN) {
        ...
        sdata = (struct ieee80211_sub_if_data *)kzalloc(sizeof(*sdata) + local->hw.vif_data_size,
                GFP_KERNEL);
        if (!sdata)
            return -ENOMEM;
        wdev = &sdata->wdev;
...
struct notifier_block mac80211_netdev_notifier = {

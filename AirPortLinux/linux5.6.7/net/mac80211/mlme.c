                ...
                enum ieee80211_smps_mode smps)
{
    ...
    /* reserve and fill IE */
    pos = (u8 *)skb_put(skb, sizeof(struct ieee80211_ht_cap) + 2);
                 ...
                 struct ieee80211_vht_cap *ap_vht_cap)
{
    ...
    /* reserve and fill IE */
    pos = (u8 *)skb_put(skb, sizeof(struct ieee80211_vht_cap) + 2);
                ...
                struct ieee80211_supported_band *sband)
{
    ...
    pos = (u8 *)skb_put(skb, he_cap_size);
...
static void ieee80211_send_assoc(struct ieee80211_sub_if_data *sdata)
{
    ...
    mgmt = (struct ieee80211_mgmt *)skb_put_zero(skb, 24);
    ...
    /* SSID */
    pos = (u8 *)skb_put(skb, 2 + assoc_data->ssid_len);
    ie_start = pos;
    *pos++ = WLAN_EID_SSID;
    *pos++ = assoc_data->ssid_len;
    ...
    pos = (u8 *)skb_put(skb, supp_rates_len + 2);
    ...
    *pos++ = supp_rates_len;
    ...
    if (rates_len > count) {
        pos = (u8 *)skb_put(skb, rates_len - count + 2);
    ...
    if (capab & WLAN_CAPABILITY_SPECTRUM_MGMT) {
        ...
        pos = (u8 *)skb_put(skb, 2 * sband->n_channels + 2);
    ...
    if (ieee80211_hw_check(&local->hw, SUPPORTS_ONLY_HE_MULTI_BSSID) &&
        ...
        elem = (struct element *)cfg80211_find_elem(WLAN_EID_EXT_CAPABILITY,
                          assoc_data->ie,
                          assoc_data->ie_len);
    ...
    if (assoc_data->ie_len) {
        ...
        noffset = ieee80211_ie_split(assoc_data->ie, assoc_data->ie_len,
                         ...
                         offset);
        pos = (u8 *)skb_put(skb, noffset - offset);
    ...
    ifmgd->assoc_req_ies = (u8 *)kmemdup(ie_start, pos - ie_start, GFP_ATOMIC);
                      ...
                      struct ieee80211_sub_if_data *sdata)
{
    ...
    nullfunc = (struct ieee80211_hdr *)skb_put_zero(skb, 30);
                 ...
                 int *chan_pwr, int *pwr_reduction)
{
    ...
    triplet = (struct ieee80211_country_ie_triplet *)(country_ie + 3);
    country_ie_len -= 3;
                    ...
                    struct ieee802_11_elems *elems)
{
    ...
    if ((assoc_data->wmm && !elems->wmm_param) ||
        ...
        ies = rcu_dereference(cbss->ies);
        if (ies)
            bss_ies = (const struct cfg80211_bss_ies *)kmemdup(ies, sizeof(*ies) + ies->len,
                      GFP_ATOMIC);
        rcu_read_unlock();
        if (!bss_ies)
            return false;
                     ...
                     struct cfg80211_bss *cbss)
{
    ...
    if (vht_cap_ie && vht_cap_ie[1] >= sizeof(*vht_cap)) {
        ...
        vht_cap = (const struct ieee80211_vht_cap *)(vht_cap_ie + 2);
                  ...
                  struct cfg80211_bss *cbss)
{
    ...
    if (!(ifmgd->flags & IEEE80211_STA_DISABLE_HT) &&
        ...
        if (ht_oper_ie && ht_oper_ie[1] >= sizeof(*ht_oper))
            ht_oper = (const struct ieee80211_ht_operation *)(ht_oper_ie + 2);
    ...
    if (!(ifmgd->flags & IEEE80211_STA_DISABLE_VHT) &&
        ...
        if (vht_oper_ie && vht_oper_ie[1] >= sizeof(*vht_oper))
            vht_oper = (const struct ieee80211_vht_operation *)(vht_oper_ie + 2);
        if (vht_oper && !ht_oper) {
            vht_oper = NULL;
            sdata_info(sdata,
    ...
    if (!(ifmgd->flags & IEEE80211_STA_DISABLE_HE)) {
        ...
        if (he_oper_ie &&
            ...
            he_oper = (const struct ieee80211_he_operation *)(he_oper_ie + 3);
        else
            he_oper = NULL;
                   ...
                   u8 *dtim_count, u8 *dtim_period)
{
    ...
    if (valid)
        tim = (const struct ieee80211_tim_ie *)(tim_ie + 2);
    ...
    idx = (const struct ieee80211_bssid_index *)(idx_ie + 2);
               ...
               struct cfg80211_auth_request *req)
{
    ...
    auth_data = (struct ieee80211_mgd_auth_data *)kzalloc(sizeof(*auth_data) + req->auth_data_len +
            ...
            struct cfg80211_assoc_request *req)
{
    struct ieee80211_local *local = sdata->local;
    struct ieee80211_if_managed *ifmgd = &sdata->u.mgd;
    struct ieee80211_bss *bss = (struct ieee80211_bss *)req->bss->priv;
    ...
    assoc_data = (struct ieee80211_mgd_assoc_data *)kzalloc(sizeof(*assoc_data) + req->ie_len, GFP_KERNEL);
    if (!assoc_data)
        return -ENOMEM;

...
//    lockdep_set_class(&list->lock, _class);
}
...
{
    return (char *)page_address(skb_frag_page(frag)) + skb_frag_off(frag);
}
...
static inline void *skb_frag_address_safe(const skb_frag_t *frag)
{
    ...
    return (char *)ptr + skb_frag_off(frag);
}
...
#define __it_diff(a, b, op) (*(u##op *)__it(a, op)) ^ (*(u##op *)__it(b, op))
    ...
    return diffs;
#else
    return memcmp((char *)a - meta_len, (char *)b - meta_len, meta_len);
#endif
}
...
//        skb_postpull_rcsum(skb, skb->data, (char *)ptr - (void *)skb->data);
    }

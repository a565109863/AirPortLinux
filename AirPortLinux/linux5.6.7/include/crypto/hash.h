...
#define AHASH_REQUEST_ON_STACK(name, ahash) \
    ...
    struct ahash_request *name = (struct ahash_request *)__##name##_desc
...
struct ahash_alg {
    ...
    int (*_final)(struct ahash_request *req);
    int (*finup)(struct ahash_request *req);
    int (*digest)(struct ahash_request *req);
    int (*_export)(struct ahash_request *req, void *_out);
    int (*import)(struct ahash_request *req, const void *_in);
...
struct shash_alg {
    ...
    int (*update)(struct shash_desc *desc, const u8 *data,
              unsigned int len);
    int (*_final)(struct shash_desc *desc, u8 *_out);
    int (*finup)(struct shash_desc *desc, const u8 *data,
             unsigned int len, u8 *_out);
    int (*digest)(struct shash_desc *desc, const u8 *data,
              unsigned int len, u8 *_out);
    int (*_export)(struct shash_desc *desc, void *_out);
    int (*import)(struct shash_desc *desc, const void *_in);
 ...
 */
static inline int crypto_ahash_export(struct ahash_request *req, void *_out)
{
    return crypto_ahash_reqtfm(req)->_export(req, _out);
}
 ...
 */
static inline int crypto_ahash_import(struct ahash_request *req, const void *_in)
{
    ...
    struct crypto_ahash *tfm, gfp_t gfp)
{
    ...
    req = (struct ahash_request *)kmalloc(sizeof(struct ahash_request) +
...
static inline void ahash_request_set_callback(struct ahash_request *req,
                          u32 flags,
                          crypto_completion_t _compl,
                          void *data)
{
    req->base.complete = _compl;
    req->base.data = data;
 ...
 */
static inline int crypto_shash_export(struct shash_desc *desc, void *_out)
{
    return crypto_shash_alg(desc->tfm)->_export(desc, _out);
}
 ...
 * Return: 0 if the import was successful; < 0 if an error occurred
 */
static inline int crypto_shash_import(struct shash_desc *desc, const void *_in)
{
    ...
    return crypto_shash_alg(tfm)->import(desc, _in);
}
 ...
 *       occurred
 */
int crypto_shash_final(struct shash_desc *desc, u8 *_out);
